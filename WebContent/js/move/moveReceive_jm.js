...
//	var inGroupNoHtml = info.inGroupNo;
	...
	if("2" == jQuery("#billType").val()){
		var freeReturnFlag = info.freeReturnFlag?"是":"否";
		htmlArr = [chkHtml, freeReturnFlag, info.freeLeftDays, info.createDate, ornaCodeHtml, ornaDscHtml, inGroupNoHtml, itemClassHtml, ornaClassHtml, analysisNameHtml, styleNameHtml, unitHtml, 
		           allWeightHtml, nowQtyHtml, grainsHtml, posAmountHtml, mainWeight, partWeight, statusHtml, deleteHtml];
	}else{
		htmlArr = [chkHtml, ornaCodeHtml, ornaDscHtml, inGroupNoHtml, itemClassHtml, ornaClassHtml, analysisNameHtml, styleNameHtml, unitHtml, 
		               allWeightHtml, nowQtyHtml, grainsHtml, posAmountHtml, mainWeight, partWeight, statusHtml, deleteHtml];
	}
