...
public class LabelTagApplyLine {

	private String id	;//	标签申请单行表id
	private String headId	;//	标签申请单id
	private String ornaCode	;//	饰品编码
	private String ornaName	;//	饰品名称
	private String unitId	;//	计量单位
	private String num	;//	数量
	private String weighr	;//	重量
	...
	private String oldSpecialWorkPrice	;//	老特殊工费
	...
	public String getWeighr() {
		return weighr;
	}
	public void setWeighr(String weighr) {
		this.weighr = weighr;
	}
