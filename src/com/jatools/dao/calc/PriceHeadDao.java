...
public interface PriceHeadDao {
	...
	void updatePriceAccLine(List<PriceAccLine> lineList);
	...
	void updatePriceAcsLine(List<PriceAcsLine> lineList);
	...
	void updatePriceSbraLine(List<PriceSbraLine> lineList);
	/**
	 * 保存石头行
	 * @param headid
	 */
	 ...
	 * @return
	 */
	List<CashProdAccount>getAccountByCode(String code);
	void deleteUserById(String id);
	void updateUserNumsById(String id);
	void saveAccountUser(CashProdUser user);
	...
	String getProdUseraNumBySid(String id);
	List<MaterIniv> getTLCodeById(String headId);
	List<MaterIniv> getLTXTCodeById(String headId);
	
	List<MaterIniv> getTLCodeById(String headId, String ornaCode);
	
	List<MaterIniv> getLTXTCodeById(String headId, String ornaCode);
	...
	void savePriceStoneLine(PriceStoneLine line);
	
	void updatePriceStoneLine(PriceStoneLine line);
	
	void deleteStoneLineByLineId(String lineId);
	void deleteSbraLineByLineId(String lineId);
	void deleteAccLineByLineId(String lineId);
	void deleteAcsLineByLineId(String lineId);
	
	void insertProdAccountUser(String priceLineId, String prId, String ornaCode, String userNum, String userId);
}
