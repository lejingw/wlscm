...
public class LeftGoldOutStockController extends BaseOutStockController {
	private Logger logger = Logger.getLogger(this.getClass());
	@Override
	public ModelAndView doSubPerform(HttpServletRequest req, HttpServletResponse res) {
		OutStockForm form = new OutStockForm();
		getPagerData(form,req,"4");
		return new ModelAndView("out/leftGoldOutStock_list", "form", form);
	}
	//0丢失1报废2礼品3营销4余金领用
	...
	public ModelAndView toAdd(HttpServletRequest req, HttpServletResponse res) {
		...
		return new ModelAndView("out/leftGoldOutStock_edit", "form", form);
	}
	...
	public ModelAndView exportExcel(HttpServletRequest req, HttpServletResponse res) {
		OutStockForm form = new OutStockForm();
		getPagerData(form,req,"4");
		baseExportExcel(req, res, "4", "余金领用单",form.getPager());
		return null;
	}
	...
	public ModelAndView exportExcelLine(HttpServletRequest req, HttpServletResponse res) {
		...
		baseExportExcelLine(req, headId, "余金领用单",res);
		return null;
	}
}
