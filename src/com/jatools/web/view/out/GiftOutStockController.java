...
public class GiftOutStockController extends BaseOutStockController {
	private Logger logger = Logger.getLogger(this.getClass());
	@Override
	public ModelAndView doSubPerform(HttpServletRequest req,
			HttpServletResponse res) {
		OutStockForm form = new OutStockForm();
		getPagerData(form,req,"2");
		return new ModelAndView("out/giftOutStock_list", "form", form);
	}
	//0丢失1报废2礼品3营销4余金领用
	...
	public ModelAndView toAdd(HttpServletRequest req, HttpServletResponse res) {
		...
		return new ModelAndView("out/giftOutStock_edit", "form", form);
	}
	...
	public ModelAndView exportExcel(HttpServletRequest req, HttpServletResponse res) {
		OutStockForm form = new OutStockForm();
		getPagerData(form,req,"2");
		baseExportExcel(req, res, "2", "礼品出库单",form.getPager());
		return null;
	}
	...
	public ModelAndView exportExcelLine(HttpServletRequest req, HttpServletResponse res) {
		...
		baseExportExcelLine(req, headId, "礼品出库单",res);
		return null;
	}
}
